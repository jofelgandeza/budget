...
//            console.log(foundlist)
        ...
        if (!isNull(emPosit)) {
            branAsignDesc = emPosit.branch_desc
            areaBranches = emPosit
        }
    ...
    //            const empStatus = fndEmployees.status
        if (fndBranch.length === 0) {
            ...
            fndBranch.forEach(fndBranchs =>{
                ...
                foundBranch.push({id: id, areaCode: areaCode, branchCode: branchCode, branchDesc: branchDesc, branchCategory: branchCategory, emp_code: branchEmp, empName: empName, branchStat: branchStat})
