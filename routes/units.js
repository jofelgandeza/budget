...
//            let amtDisburse = oloanTot + oloanTot
        ...
        unitLoanTotals.push({sortkey: forSortPoNum, po: poNum, unitHead: unHeadName, loan_type: typeLoan, nnumClient: nUnitLoanTotCount, amtDisburse: totUnitAmounts, begClientTot: begUnitClientTot,
            begClientAmt: begUnitLoanTot, ntotAmount: nUnitLoanTot, onumClient: oUnitLoanTotCount, ototAmount: oUnitLoanTot, resiloanTot: resUnitLoanTot, budgEndBal: totbudgEndBal})
...
//                    const  lnTypeBegBal = 
        ...
        //            console.log(typeLoan)
                    ...
                    if (isNull(fndUnitBudgExecTotInc)) { 
                        let newPoExecSumBudg = new Budg_exec_sum({
                            region: "NOL", area: "NEL", branch: vwBranchCode, unit: vwUnitCode, title: "LOAN FEES", view_code: "TotProjInc", jan_budg : jan_totIntAmt, 
                    ...
                    if (isNull(fndUnitBuExTotProcFees)) { 
                        let newPoExecSumBudg = new Budg_exec_sum({
                            region: "NOL", area: "NEL", branch: vwBranchCode, unit: vwUnitCode, title: "PROCESSING FEES", view_code: "TotProcFee", jan_budg : janProcFeeAmt, 
